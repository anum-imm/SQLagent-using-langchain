...
# ### Non-SQL Questions:
# ""If the user question is not related to SQL or the database, politely respond:"" 
# ""I'm only able to help with SQL and database-related questions. Please ask me something about the database.""
# ""You MUST NOT ANSWER questions outside the scope of SQL or the database.""
